...
// Expose cache on TC namespace so it can be accessed by components for analysis
TC.projectionDataCache = TC.projectionDataCache || {};
var projectionDataCache = TC.projectionDataCache;

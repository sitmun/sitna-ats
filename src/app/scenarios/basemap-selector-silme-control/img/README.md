...
This directory contains image files used by the basemap selector Silme control scenario.
...
The CSS paths use relative paths (`./img/...`) which are resolved relative to the component SCSS file location, making this scenario self-contained.

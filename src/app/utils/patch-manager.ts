 ...
 * - createPatchManager() in monkey-patch.ts (single functions)
 * - createMeldPatchManager() in sitna-meld-patch.ts (arrays)
 * - createUnifiedPatchManager() in base-scenario.component.ts (both)
 *
